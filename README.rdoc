...
Alerts are retained for as long as you remain on the page, and are dismissed when you leave.
...
JSON API:
"app_params" PARAMETERS [<test: boolean>]
RETURNS 
...
"data_since" PARAMETERS [time: <Unix timestamp>], [<test: boolean>]
